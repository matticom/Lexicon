...
public class SearchResultPanelStatic extends TechnicalTermPanelStatic {
	...
	protected void createLabelsExtends() {
		...
		WinUtil.configLabel(germanResultTechnicalTerm, (int)(displaySize.getWidth() * 200/1920), (int)(displaySize.getHeight() * 30/1200), Color.WHITE, WinUtil.LIGHT_BLACK, 15, Font.BOLD);
		...
		WinUtil.configLabel(germanResultSpecialty, (int)(displaySize.getWidth() * 200/1920), (int)(displaySize.getHeight() * 30/1200), Color.WHITE, WinUtil.LIGHT_BLACK, 15, Font.BOLD);
		...
		WinUtil.configLabel(spanishResultTechnicalTerm, (int)(displaySize.getWidth() * 200/1920), (int)(displaySize.getHeight() * 30/1200), Color.WHITE, WinUtil.LIGHT_BLACK, 15, Font.BOLD);
		...
		WinUtil.configLabel(spanishResultSpecialty, (int)(displaySize.getWidth() * 200/1920), (int)(displaySize.getHeight() * 30/1200), Color.WHITE, WinUtil.LIGHT_BLACK, 15, Font.BOLD);
