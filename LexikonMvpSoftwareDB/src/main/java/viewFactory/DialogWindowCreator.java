...
public class DialogWindowCreator {
	...
	public MyWindow createWindow(DialogWindows window, ResourceBundle languageBundle, List<TechnicalTerm> technicalTermList, ChooseSpecialtyComboBox specialtyComboBox) {
		...
		MyWindow myWindow = windowFactory(window, languageBundle, null, null, technicalTermList, null, specialtyComboBox);
		return myWindow;
	}
	...
	public MyWindow createWindow(DialogWindows window, ResourceBundle languageBundle, AssignmentTableRowObject[] tableRowObjectArray) {
		...
		MyWindow myWindow = windowFactory(window, languageBundle, null, null, null, tableRowObjectArray, null);
		return myWindow;
	}
	...
	protected MyWindow windowFactory(DialogWindows window, ResourceBundle languageBundle, ChooseSpecialtyComboBox germanSpecialtyComboBox,
			ChooseSpecialtyComboBox spanishSpecialtyComboBox, List<TechnicalTerm> technicalTermList, AssignmentTableRowObject[] tableRowObjectArray, ChooseSpecialtyComboBox specialtyComboBox) {
