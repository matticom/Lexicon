...
public class TechnicalTermCreationWindow extends MyWindow {
	...
	private void arrangeComboBoxes() {
		...
		GridBagLayoutUtilities.addGB(contentPane, germanSpecialtyComboBox, 1, 5, 1, 1, GridBagConstraints.HORIZONTAL, 1, 0,
				new Insets(0, WinUtil.relW(SIDE_WIDTH), WinUtil.relH(10), WinUtil.relW(SIDE_WIDTH)));
		GridBagLayoutUtilities.addGB(contentPane, spanishSpecialtyComboBox, 3, 5, 1, 1, GridBagConstraints.HORIZONTAL, 1, 0,
				new Insets(0, WinUtil.relW(SIDE_WIDTH), WinUtil.relH(10), WinUtil.relW(SIDE_WIDTH)));
	}
	...
	private void createTextAreas() {
		...
		GridBagLayoutUtilities.addGB(contentPane, germanScrollPane, 1, 6, 1, 2, GridBagConstraints.BOTH, 1, 1,
		...
		GridBagLayoutUtilities.addGB(contentPane, spanishScrollPane, 3, 6, 1, 2, GridBagConstraints.BOTH, 1, 1,
				new Insets(0, WinUtil.relW(SIDE_WIDTH), WinUtil.relH(BOTTOM_HEIGHT), WinUtil.relW(SIDE_WIDTH)));
	}
	...
	private void createInsertButton() {
		...
		GridBagLayoutUtilities.addGB(contentPane, insertButton, 2, 7, 1, 1, GridBagConstraints.NONE, 0, 1,
	...
	private void createLabels() {
		...
		GridBagLayoutUtilities.addGB(contentPane, specialtyLabel, 2, 5, 1, 1, GridBagConstraints.BOTH, 0, 0, new Insets(0, 0, WinUtil.relH(10), 0));
